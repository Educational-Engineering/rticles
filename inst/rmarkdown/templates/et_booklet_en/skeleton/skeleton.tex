...
\item[] keywords \item[] not capitalized \item[] Java
\end{itemize}%
\end{multicols}%
\vspace{-2mm}%
\hrule%
...
\vspace{0.5 cm} {\large \textsf{A Capitalized Title}}


\vspace{0.5 cm} {\LARGE \textbf{ \textsf{A Capitalized Title: Something about a Package}}}\\
\vspace{0.5 cm} {\Large \textsf{A Capitalized Title: Something about a Package foo}}
...
\end{center}
 ...
 \begin{center}
  	\vspace{1 cm}Authors: \\ \vspace{2 mm}FirstName LastName, Second Author \\
  	\vspace{0.5cm}E-Mail: \\ \vspace{2 mm} \href{mailto:et@ethz.ch}{\nolinkurl{et@ethz.ch}} \\
   	\vspace{0.5 cm}Date: \\ \vspace{2 mm} 15 April, 2016 \\
   	\vspace{0.5 cm}  Version: 1\\
   	\vspace{2 mm}  Hash: fcc53f8
