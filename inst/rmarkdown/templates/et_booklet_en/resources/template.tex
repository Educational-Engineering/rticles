...
% ============ style inline code ===================
\BeforeBeginEnvironment{verbatim}{\begin{mdframed}[style=code]\vspace{-.5em}}
\AfterEndEnvironment{verbatim}{\vspace{-1em}\end{mdframed}\unskip}
\begingroup\lccode`~=`"
\lowercase{\endgroup
...
$if(translator)$
  	\vspace{0.5 cm}Translators: \\ \vspace{2 mm}$for(translator)$$translator.name$$sep$, $endfor$ \\
$endif$
