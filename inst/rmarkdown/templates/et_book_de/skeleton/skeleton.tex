...
\newpairofpagestyles[scrheadings]{impressum}{\cfoot{\footnotesize  Version: 1, Datum: 18 April, 2016, Hash:  2458548}}
...
\addcontentsline{toc}{part}{\protect\numberline{\thepart} Module 0 }
\par \raisebox{0\height}{\includegraphics[width=0.45\textwidth]{figures/ethlogo-print.png}}
\hfill \raisebox{0\height}{\includegraphics[width=0.25\textwidth]{figures/Logo.png} }
\par 

\begin{center} \noindent\rule{\textwidth}{0.4pt}\\ \vspace{0.5 cm} {\large \textsf{ A Capitalized Title }}\\ \vspace{0.5 cm} {\LARGE \textbf{ \textsf{ Module 0  }}}\\ \vspace{0.5 cm} {\Large \textsf{ Theorieteil }}\\ \noindent\rule{\textwidth}{0.4pt}\\ \vspace{1 cm}Autoren: \\ \vspace{2 mm} FirstName LastName, Second Author \\ \end{center}
