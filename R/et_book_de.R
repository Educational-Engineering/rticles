...
loadChapter <- function(path = NULL,
  ...
  if(displayKeywords){
    result <- paste(
        ...
        "\\vspace{0.5 cm} {\\large \\textsf{",metadata$title$course,"}\\par}",
        "\\vspace{0.5 cm} {\\LARGE \\textbf{\\textsf{", metadata$title$main," }}\\par}",
        "\\vspace{0.5 cm} {\\Large \\textsf{", metadata$title$subtitle,"}\\par}",
        "\\noindent\\rule{\\textwidth}{0.4pt}\\\\",
